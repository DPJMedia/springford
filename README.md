...
NEXT_PUBLIC_SITE_URL=https://www.springford.press
...
# Optional: signed “cancel from email” links (defaults to STRIPE_WEBHOOK_SECRET if unset)
# SUPPORT_CANCEL_TOKEN_SECRET=...
```
