...
export const AD_SLOT_LABELS: Record<string, string> = {
  ...
  "article-after-image": "Desktop Article 1",
  "article-inline-1": "Desktop Article 2",
  "article-inline-2": "Desktop Article 3",
  "article-sidebar-top": "Desktop Article 4",
  "article-sidebar-bottom": "Desktop Article 5",
  // Mobile — Article
  "article-mobile-after-image": "Mobile Article 1",
...
export const AD_SLOT_TABLE_LABELS: Record<string, string> = {
  ...
  "article-after-image": "Desktop Article Tier 1",
  "article-inline-1": "Desktop Article Tier 2",
  "article-inline-2": "Desktop Article Tier 3",
  "article-sidebar-top": "Desktop Article Tier 4",
  "article-sidebar-bottom": "Desktop Article Tier 5",
  "article-mobile-after-image": "Mobile Article Tier 1",
