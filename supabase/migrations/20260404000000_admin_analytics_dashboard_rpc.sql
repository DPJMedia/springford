-- Pre-aggregated analytics for the admin dashboard (replaces fetching tens of thousands of page_views rows in the browser).
...
COMMENT ON FUNCTION public.get_admin_analytics_dashboard IS
  'Admin analytics aggregates in one round trip; callable only with service role.';
