        ...
        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width: 640px; background: #e0e0e0;">
              ...
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background: #ffffff; border: 1px solid #d0d0d0;">
                <tr>
                  <td style="padding: 40px 48px 32px;">
                    <h2 style="margin: 0 0 20px; font-size: 24px; font-weight: 700; color: #000000; letter-spacing: -0.02em;">
          ...
          <tr>
            <td style="padding: 0 24px 24px;">
              <p style="margin: 0; font-size: 13px; color: #333333; text-align: center;">
              ...
              <p style="margin: 4px 0 0; font-size: 11px; color: #999999; text-align: center;">
