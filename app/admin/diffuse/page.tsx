      ...
      <div className="mx-auto max-w-7xl px-4 py-8">
        ...
        {!connection ? (
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-xl p-8 shadow-[0_10px_15px_-3px_rgba(255,150,40,0.3)] max-w-2xl mx-auto">
            ...
            <div className="mt-8 p-5 bg-[#c086fa]/10 border border-[#c086fa]/20 rounded-xl backdrop-blur-xl">
              <p className="text-sm text-[#c086fa] leading-relaxed">
                <strong className="font-semibold">Note:</strong> Your credentials are only used to verify your identity and are not stored. We only save the connection between your Spring-Ford Press and DiffuseAI accounts.
              </p>
            </div>
          </div>
        ) : (
